...
namespace RobinCore
{
    public class AzureKeyVaultRobin
    {
        ...
        public AzureKeyVaultRobin(IAppSettings appConfig)
        {
            _appConfig = appConfig;
        }

        public async Task<ViziteLoginRequest>? RobinAzureKeyVault(string AzureKeyVaultCode)
        {
            ...
            SecretClient SecretClient = new SecretClient(new Uri(_appConfig.url), credential);
